...
Namespace Route4MeSDK.DataTypes.V5
    ...
    Public NotInheritable Class RouteParameters
        ...
        <DefaultValue(False)>
        Public Property AdvancedConstraints As V5.RouteAdvancedConstraints()
    ...
    Public Class SlowdownParams
        ...
        Public Sub New(ByVal serviceTime As Integer?, ByVal travelTime As Integer?)
