...
Namespace Route4MeSDK.DataTypes
    ...
    Public Class Address
        ...
        ''' <summary>
        ''' The id of the optimization request that was used 
        ''' to initially instantiate this route
        ''' </summary>
        ...
        ''' <summary>
        ''' The pass-through data about this route destination. 
        ...
        ''' <summary>
        ''' The number of pieces/palllets that this destination/order/line-item 
        ''' consumes/contains on a vehicle
        ''' </summary>
        ...
        ''' The pass-through data about this route destination. 
        ''' The data will be visible on the manifest, website, and mobile apps. 
        ''' Also used to email clients when vehicles are approaching 
        ''' (future capability).
        ''' </summary>
        ...
        ''' The pass-through data about this route destination. 
        ''' The data will be visible on the manifest, website, and mobile apps. 
        ''' Also used to sms message clients when vehicles are approaching 
        ''' (future capability).
        ''' </summary>
        ...
        ''' <summary>
        ''' The number of notes that are already associated with this address 
        ''' on the route.
        ''' </summary>
        ...
        ''' <summary>
        ''' Server-side generated amount of km/miles that it will take to get 
        ...
        ''' <summary>
        ''' Server-side generated amount of seconds that it will take 
        ...
        ''' <summary>
        ''' Estimated time window start based on the optimization engine, 
        ...
        ''' <summary>
        ''' The expected amount of time that will be spent at this address 
        ''' by the driver/user
        ''' </summary>
        ...
        ''' <summary>
        ''' If present, the priority will sequence addresses in all the optimal routes 
        ''' so that higher priority addresses are general at the beginning 
        ''' of the route sequence.
        ...
        <[ReadOnly](True)>
        Public Property GeofenceDetectedVisitedTimestamp As Long?
        ...
        <[ReadOnly](True)>
        Public Property GeofenceDetectedDepartedTimestamp As Long?
        ...
        <[ReadOnly](True)>
        Public Property GeofenceDetectedService_time As Integer?
        ...
        <[ReadOnly](True)>
        Public Property GeofenceDetectedVisitedLat As Double?
        ...
        <[ReadOnly](True)>
        Public Property GeofenceDetectedVisitedLng As Double?
        ...
        <[ReadOnly](True)>
        Public Property GeofenceDetectedDepartedLat As Double?
        ...
        <[ReadOnly](True)>
        Public Property GeofenceDetectedDepartedLng As Double?
