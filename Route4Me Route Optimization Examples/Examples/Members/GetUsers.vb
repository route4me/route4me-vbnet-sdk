...
Namespace Route4MeSDKTest.Examples
    Partial Public NotInheritable Class Route4MeExamples
        Public Sub GetUsers()
            ...
            Dim dataObjects As Route4MeManager.GetUsersResponse = route4Me.
                GetUsers(parameters, errorString)
            ...
            If dataObjects IsNot Nothing Then
                ...
                If dataObjects.results IsNot Nothing Then
                    Console.WriteLine(
                        "GetUsers executed successfully, {0} users returned",
                        dataObjects.results.Length
                    )
